class DropPresenterConsoleStorage < ActiveRecord::Migration[8.1]
  def up
    drop_table :presenter_blocks
    drop_table :presenter_claims
    remove_column :game_sessions, :presenter_device_digest
    remove_column :game_sessions, :presenter_locale
    remove_column :game_sessions, :presenter_token_digest
  end

  def down
    add_column :game_sessions, :presenter_token_digest, :string
