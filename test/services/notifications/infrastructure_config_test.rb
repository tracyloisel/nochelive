...
class Notifications::InfrastructureConfigTest < ActiveSupport::TestCase
  ...
  test "Solid Queue gives transactional notifications precedence and owns recurrence" do
    ...
    assert_equal "DailyEditorialPublicationCoordinatorJob", recurring.dig("publish_scheduled_library_editorials", "class")
    assert_equal "every 15 minutes", recurring.dig("publish_scheduled_library_editorials", "schedule")
