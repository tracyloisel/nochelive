...
Family quiz in a chapel cultural hall, not a stadium and not a horror film. Conseil payoff loop: hit → **named SFX** (+ haptic when the phone is the controller) — a silent correct is unfinished.
