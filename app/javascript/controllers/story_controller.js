...
const STREET_AVOID = "button, a, input, textarea, select, label, .buzz, .choice-btn, .quiz-bar, .quiz-next, .btn, .play-sheet-grip, .home-menu, .chrome-tools, .mute, .lang-switch, .claim-veil, .claim-modal, .street-map-dot, .street-map, .profile-gate"
