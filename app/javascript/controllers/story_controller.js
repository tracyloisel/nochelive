...
const AVOID = "button, a, input, textarea, select, label, .choice-btn, .quiz-bar, .quiz-next, .btn, .story-sheet, .play-sheet, .play-sheet-body, .play-sheet-grip, .scripture-veil, .scripture-sheet"
const STREET_AVOID = "button, a, input, textarea, select, label, .choice-btn, .quiz-bar, .quiz-next, .btn, .play-sheet, .play-sheet-body, .play-sheet-grip, .street-shot-actions, .street-score, .play-timer, .home-menu, .chrome-tools, .mute, .lang-switch, .scripture-veil, .scripture-sheet, .quiz-hud, .quiz-sheet, .quiz-scripture, .quiz-dock, .quiz-hud-streak"
