...
const STREET_AVOID = "button, a, input, textarea, select, label, .buzz, .choice-btn, .quiz-bar, .quiz-next, .btn, .play-sheet, .play-sheet-body, .play-sheet-grip, .street-quiz-head, .street-shot-rival, .street-shot-actions, .street-score, .play-timer, .home-menu, .chrome-tools, .mute, .lang-switch, .claim-veil, .claim-modal, .street-map-dot, .street-map, .profile-gate, .scripture-veil, .scripture-sheet"
